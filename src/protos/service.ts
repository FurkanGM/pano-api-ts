...
class Post$Type extends MessageType<Post> {
    ...
    create(value?: PartialMessage<Post>): Post {
        const message = { id: "", title: "", url: "", content: "", slug: "", userId: "" };
...
class GetBatchPostsRequest$Type extends MessageType<GetBatchPostsRequest> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GetBatchPostsRequest): GetBatchPostsRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: GetBatchPostsRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
...
class GetBatchPostsResponse$Type extends MessageType<GetBatchPostsResponse> {
    constructor() {
        super("kampus.panoapi.GetBatchPostsResponse", [
            { no: 1, name: "posts", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => Post }
        ]);
    }
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GetBatchPostsResponse): GetBatchPostsResponse {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: GetBatchPostsResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
...
class UpdatePostRequest$Type extends MessageType<UpdatePostRequest> {
    ...
    internalBinaryWrite(message: UpdatePostRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.title)
            StringValue.internalBinaryWrite(message.title, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
...
class Comment$Type extends MessageType<Comment> {
    ...
    create(value?: PartialMessage<Comment>): Comment {
        const message = { id: "", content: "", userId: "", postId: "", parentId: "" };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
...
class GetBatchCommentsRequest$Type extends MessageType<GetBatchCommentsRequest> {
    ...
    create(value?: PartialMessage<GetBatchCommentsRequest>): GetBatchCommentsRequest {
        const message = { ids: [] };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GetBatchCommentsRequest): GetBatchCommentsRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: GetBatchCommentsRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* repeated string ids = 1; */
        for (let i = 0; i < message.ids.length; i++)
            writer.tag(1, WireType.LengthDelimited).string(message.ids[i]);
        let u = options.writeUnknownFields;
...
class GetBatchCommentsResponse$Type extends MessageType<GetBatchCommentsResponse> {
    constructor() {
        super("kampus.panoapi.GetBatchCommentsResponse", [
            { no: 1, name: "Comments", kind: "message", jsonName: "Comments", repeat: 1 /*RepeatType.PACKED*/, T: () => Comment }
        ]);
    }
    create(value?: PartialMessage<GetBatchCommentsResponse>): GetBatchCommentsResponse {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GetBatchCommentsResponse): GetBatchCommentsResponse {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: GetBatchCommentsResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
...
class CreateCommentResponse$Type extends MessageType<CreateCommentResponse> {
    constructor() {
        super("kampus.panoapi.CreateCommentResponse", [
            { no: 1, name: "Comment", kind: "message", jsonName: "Comment", T: () => Comment }
        ]);
    }
...
class Upvote$Type extends MessageType<Upvote> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: Upvote): Upvote {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: Upvote, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string id = 1; */
        if (message.id !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.id);
        /* string entity_id = 2; */
...
class GetUpvotesRequest$Type extends MessageType<GetUpvotesRequest> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GetUpvotesRequest): GetUpvotesRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: GetUpvotesRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string entity_id = 1; */
        if (message.entityId !== "")
...
class GetUpvotesResponse$Type extends MessageType<GetUpvotesResponse> {
    constructor() {
        super("kampus.panoapi.GetUpvotesResponse", [
            { no: 1, name: "upvotes", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => Upvote }
        ]);
    }
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GetUpvotesResponse): GetUpvotesResponse {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* repeated kampus.panoapi.Upvote upvotes */ 1:
                    message.upvotes.push(Upvote.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: GetUpvotesResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* repeated kampus.panoapi.Upvote upvotes = 1; */
        for (let i = 0; i < message.upvotes.length; i++)
            Upvote.internalBinaryWrite(message.upvotes[i], writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class CreateUpvoteRequest$Type extends MessageType<CreateUpvoteRequest> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: CreateUpvoteRequest): CreateUpvoteRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: CreateUpvoteRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string entity_id = 1; */
        if (message.entityId !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.entityId);
        /* string entity_type = 2; */
...
class CreateUpvoteResponse$Type extends MessageType<CreateUpvoteResponse> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: CreateUpvoteResponse): CreateUpvoteResponse {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* kampus.panoapi.Upvote upvote */ 1:
                    message.upvote = Upvote.internalBinaryRead(reader, reader.uint32(), options, message.upvote);
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: CreateUpvoteResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* kampus.panoapi.Upvote upvote = 1; */
        if (message.upvote)
            Upvote.internalBinaryWrite(message.upvote, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class DeleteUpvoteRequest$Type extends MessageType<DeleteUpvoteRequest> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: DeleteUpvoteRequest): DeleteUpvoteRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: DeleteUpvoteRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string entity_id = 1; */
        if (message.entityId !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.entityId);
        /* string entity_type = 2; */
...
class DeleteUpvoteResponse$Type extends MessageType<DeleteUpvoteResponse> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: DeleteUpvoteResponse): DeleteUpvoteResponse {
        return target ?? this.create();
    }
    internalBinaryWrite(message: DeleteUpvoteResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class IsUpvotedRequest$Type extends MessageType<IsUpvotedRequest> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: IsUpvotedRequest): IsUpvotedRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: IsUpvotedRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string entity_id = 1; */
        if (message.entityId !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.entityId);
        /* string entity_type = 2; */
...
class IsUpvotedResponse$Type extends MessageType<IsUpvotedResponse> {
    constructor() {
        super("kampus.panoapi.IsUpvotedResponse", [
            { no: 1, name: "is_upvoted", kind: "scalar", T: 8 /*ScalarType.BOOL*/ }
        ]);
    }
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: IsUpvotedResponse): IsUpvotedResponse {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: IsUpvotedResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* bool is_upvoted = 1; */
...
export const PanoAPI = new ServiceType("kampus.panoapi.PanoAPI", [
    { name: "GetBatchPosts", options: {}, I: GetBatchPostsRequest, O: GetBatchPostsResponse },
    ...
    { name: "GetBatchComments", options: {}, I: GetBatchCommentsRequest, O: GetBatchCommentsResponse },
    ...
    { name: "GetUpvotes", options: {}, I: GetUpvotesRequest, O: GetUpvotesResponse },
    { name: "CreateUpvote", options: {}, I: CreateUpvoteRequest, O: CreateUpvoteResponse },
    { name: "DeleteUpvote", options: {}, I: DeleteUpvoteRequest, O: DeleteUpvoteResponse },
    { name: "IsUpvoted", options: {}, I: IsUpvotedRequest, O: IsUpvotedResponse }
]);
